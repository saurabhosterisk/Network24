...
public final class ActivityChannelListBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivityChannelListBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityChannelListBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_channel_list, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityChannelListBinding bind(@NonNull View rootView) {
