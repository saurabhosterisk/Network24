...
public final class DialogLoadingBinding implements ViewBinding {
  ...
  private DialogLoadingBinding(@NonNull LinearLayout rootView,
      @NonNull TextView txtLoadingMessage) {
  ...
  public static DialogLoadingBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.txtLoadingMessage;
      TextView txtLoadingMessage = ViewBindings.findChildViewById(rootView, id);
      if (txtLoadingMessage == null) {
        break missingId;
      }

      return new DialogLoadingBinding((LinearLayout) rootView, txtLoadingMessage);
    }
