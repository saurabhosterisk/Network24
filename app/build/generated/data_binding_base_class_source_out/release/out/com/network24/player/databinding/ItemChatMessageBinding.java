...
public final class ItemChatMessageBinding implements ViewBinding {
  ...
  private ItemChatMessageBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout root,
      @NonNull TextView tvSender, @NonNull TextView tvText, @NonNull TextView tvUserIcon) {
  ...
  public static ItemChatMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemChatMessageBinding((LinearLayout) rootView, root, tvSender, tvText,
          tvUserIcon);
    }
