...
import com.network24.player.databinding.ItemFavouriteCategoryBinding
import com.network24.player.features.live.models.LiveCategory

class FavouriteCategoryAdapter(
    private val columns: Int,
    private val listener: (LiveCategory) -> Unit,
    private val onLongClick: (LiveCategory) -> Unit
) : RecyclerView.Adapter<FavouriteCategoryAdapter.ViewHolder>() {

    private val list = mutableListOf<LiveCategory>()

    inner class ViewHolder(val binding: ItemFavouriteCategoryBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemFavouriteCategoryBinding.inflate(
        ...
        // Activity XML: rvFavourite marginStart+End = 16dp + 16dp, paddingLeft+Right = 4dp + 4dp => 40dp
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        // Long press -> remove from favourites
        ...
        holder.itemView.setOnFocusChangeListener { _, hasFocus ->
            if (hasFocus) {
                holder.binding.cardFavourite.strokeWidth = 3
                ...
                holder.binding.cardFavourite.strokeWidth = 0
                holder.itemView.animate()
                    .scaleX(1f)
                    .scaleY(1f)
                    .setDuration(120)
